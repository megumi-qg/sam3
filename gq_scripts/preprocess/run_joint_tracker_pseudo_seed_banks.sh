...
DETECTOR_CKPT="${DETECTOR_CKPT:-$REPO_ROOT/gq_experiment/joint/acdc_mscmr_isbi_scribble_lora_balanced/checkpoints/checkpoint_20.pt}"
OUT_ROOT="${OUT_ROOT:-$REPO_ROOT/gq_experiment/joint/acdc_mscmr_isbi_scribble_lora_balanced/pseudo_seed_bank}"

mkdir -p "$OUT_ROOT"/{acdc,mscmr,isbi}

python gq_scripts/preprocess/build_scribble_tracker_pseudo_seed_bank.py \
