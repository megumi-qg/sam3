...
# 加载微调后的检查点文件
# 可以选择原始检查点或转换后的检查点
CHECKPOINT_PATH = '/home/gaoqi/official_ckpt/sam3_hf/sam3.pt'
# /home/gaoqi/sam3/gq_experiment/acdc/full_sam3_tracker_image_init/checkpoints/val_acdc_segmentation_coco_eval_segm_AP.pt
