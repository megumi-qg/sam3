...
GPUS="${GPUS:-2,3}"
NUM_GPUS="${NUM_GPUS:-2}"
LOG_FILE="${LOG_FILE:-joint_acdc_mscmr_isbi_scribble_tracker_image_init_v2_val_macro.log}"
...
echo "Started joint tracker v2 val-macro training. PID=$! LOG=$LOG_FILE GPUS=$GPUS"
