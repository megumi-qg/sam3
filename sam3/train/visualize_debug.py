...
# ================= 配置区域 =================
# 1. 你的 ACDC 测试图片路径
IMAGE_PATH = "/home/gaoqi/sam3/dataset/ACDC_new/train/images/patient001_frame12_slice005.png" 
# (注意：确保这里是一张真实的图片路径，ACDC如果是nii需要先转成jpg/png，或者你随便找一张训练过的图)

# 2. 你的 checkpoint 路径
CHECKPOINT_PATH = "/home/gaoqi/sam3/experiment/acdc_finetune/checkpoints/checkpoint_converted.pt"
# 3. 你的配置文件名 (例如 acdc_eval.yaml)
CONFIG_NAME = "configs/acdc/acdc_train.yaml"
# ===========================================
