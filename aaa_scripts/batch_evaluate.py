...
def main():
    ...
    # 数据集路径
    test_dir = "/home/gaoqi/sam3/dataset/CAMUS/test"
    json_path = os.path.join(test_dir, "image_annotations.coco.json")
    
    # 模型配置
    bpe_path = f"{sam3_root}/sam3/assets/bpe_simple_vocab_16e6.txt.gz"
    checkpoint_path = "/home/gaoqi/sam3/experiment/acdc_camus_weak_scribble_1/checkpoints/val_camus_segmentation_coco_eval_segm_AP.pt"
    resize_size = 1008
